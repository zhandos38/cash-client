...
$resetLink = Yii::$app->urlManager->createAbsoluteUrl(['site/verify', 'token' => $user->password_reset_token]);
    ...
    <tr>
        <td style="display: block !important;clear: both !important;margin: 0 auto !important;max-width: 580px !important;">
            <table>
                ...
                <tr>
                    <td style="padding: 30px 35px;border-spacing: 0;">
                        <h2 style="font-size: 1.4em">Приветствуем Вас уважаемый <?= Html::encode($user->full_name) ?>,</h2>
                        <p>Поздравляем Вас с успешной регистрацией на платформе "IMS". Для завершения регистрации Вам необходимо активировать ваш аккаунт кликнув по кнопке "Активировать аккаунт".</p><br>
                        <table width="100%">
                            <tr>
                                <td align="center">
                                    <p>
                                        <a href="<?= Html::encode($resetLink) ?>" style=" text-decoration:none;display: inline-block;color: white;background: #00d5d4;border: solid #00d5d4;border-width: 10px 20px 8px;border-radius: 4px;">Активировать аккаунт</a>
                                    </p>
                                </td>
                            </tr>
                        </table>
                        <p><em>– С уважением к Вам, Администрация платформы "IMS"</em></p>
